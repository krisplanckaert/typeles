 ...
 * @version   $Id: Table.php,v 1.2 2012-05-02 06:36:22 bcom-dev Exp $
...
//Zend_Debug::dump($link2,'link 2');
//Zend_Debug::dump($title['value'],'titel[value]');
//Zend_Debug::dump($link2,'link 1');
//Zend_Debug::dump($colspan,'colspan');
//Zend_Debug::dump($grid);
                                } else {
                                    if ($this->getShowOrderImages() == false) {
                                        $hrefTitle = '';
                                        if (substr($title['url'], - 4) == '_ASC') {
...
//Zend_Debug::dump($this->_renderDeploy, 'test 2');
...
//Zend_Debug::dump($this->_renderDeploy, 'test 4');
...
//Zend_Debug::dump(parent::_buildTitles());
