 ...
 * @version   $Id: Grid.php,v 1.3 2012-05-02 06:36:22 bcom-dev Exp $
...
abstract class Bvb_Grid {
    ...
    protected function _buildQueryOrderAndLimit()
    {
        ...
        if ($orderf == 'DESC'
            ...
            $orderField = isset($this->_fieldsOrder[$orderField]) ? $this->_fieldsOrder[$orderField] : ''; //allan, warning 06.05.11
    ...
    protected function _buildTitles()
    {
        ...
        for ($i = 0; $i < count($this->_fields); $i++) {
            ...
            if ($this->_displayField($titles[$i])) {
                ...
                //Kris Planckaert : Bug omdat anders de title niet overgenomen wordt...
                $fieldTitle = $this->__($this->_titles[$titles[$i]]);
